...
//JBH ==========================================================================<
  ...
  return d->length; //JBH: length already in secs for JBH_USE_OLD_DSF_FORMULA
#else
...
//JBH ==========================================================================<
  ...
  if      (d->samplingFrequency ==  2822400)
    ...
    d->bitsPerSample =  256;
  else if (d->samplingFrequency == 22579200)
    d->bitsPerSample =  512;  //Aurender W20SE supports  512. 2019/04/19
  else if (d->samplingFrequency == 45158400)
    d->bitsPerSample = 1024;  //Aurender W20SE supports 1024. 2019/05/02
  else
...
//JBH ==========================================================================<
  ...
  d->length                = (d->samplingFrequency > 0) ? d->sampleCount/d->samplingFrequency : 0; //JBH: length in secs
#else
  d->bitrate
