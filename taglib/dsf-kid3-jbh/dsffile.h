...
class TAGLIB_EXPORT File : public TagLib::File
{
 public:
   ...
   * in a future version.
   */
  File(TagLib::FileName file, bool readProperties = true,
  ...
  File(TagLib::FileName file, TagLib::ID3v2::FrameFactory *frameFactory,
   ...
   * \note In the current implementation, \a propertiesStyle is ignored.
   */
  File(TagLib::IOStream *stream, TagLib::ID3v2::FrameFactory *frameFactory,
	  bool readProperties = true,
	  Properties::ReadStyle propertiesStyle = 
	  Properties::Average);
