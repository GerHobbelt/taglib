...
using namespace TagLib; //JBH turned on

//JBH changed DSFFile:: to DSF::File::
...
DSF::File::File(TagLib::FileName file, bool readProperties,
...
DSF::File::File(TagLib::FileName file, 
...
DSF::File::File(TagLib::IOStream *stream, 
		 TagLib::ID3v2::FrameFactory *frameFactory,
		 bool readProperties, 
		 Properties::ReadStyle propertiesStyle) :
  TagLib::File(stream)
...
DSF::File::File(IOStream *stream, bool readProperties, Properties::ReadStyle propertiesStyle) :
  TagLib::File(stream)
{
  d = new FilePrivate();
...
TagLib::PropertyMap DSF::File::properties() const
{
  if(d->hasID3v2)
...
void DSF::File::removeUnsupportedProperties(const TagLib::StringList &properties)
{
  if(d->hasID3v2)
    d->tag->removeUnsupportedProperties(properties);
}

TagLib::PropertyMap DSF::File::setProperties(const TagLib::PropertyMap &properties)
{
...
bool DSF::File::save(int id3v2Version, bool shrink)
{
  ...
  if(ID3v2Tag() && !ID3v2Tag()->isEmpty()) {
    ...
    TagLib::ByteVector nulls_v(DSF::Header::LONG_INT_SIZE, 0);
    TagLib::ByteVector fileSize_v;
...
TagLib::ID3v2::Tag *DSF::File::ID3v2Tag() const
{
  return d->tag;
}

void DSF::File::setID3v2FrameFactory(const TagLib::ID3v2::FrameFactory *factory)
{
