...
set INSTALL_DIRECTORY=D:/00TagLibJBH32
set INSTALL_DIRECTORY_DOS=D:\00TagLibJBH32
...
if exist 00build-general-debug rd /s/q 00build-general-debug
mkdir 00build-general-debug

cd 00build-general-debug
...
COPY /Y lib\Win32\libiconv_a_debug.lib       %INSTALL_DIRECTORY_DOS%\lib\libiconv_a_debug.lib
COPY /Y lib\Win32\libiconv_a_debug.pdb       %INSTALL_DIRECTORY_DOS%\lib\libiconv_a_debug.pdb
COPY /Y lib\Win32\libiconv_a_debug.idb       %INSTALL_DIRECTORY_DOS%\lib\libiconv_a_debug.idb
